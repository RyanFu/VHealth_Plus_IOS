...
static NSString * const Const_Invitation_Explanation = @"邀请须知：\n1. 邀请开通功能用于企业用户邀请非平台用户进行体验试用，邀请行为将被记录；\n\n2. 被邀请者成功开通账号后，可正常使用平台功能，但因体验平台所产生的健康豆（积分转化而来）不可用作商城商品兑换；\n\n3. 被邀请人的登陆账号和密码以开通时填写的被邀请者手机号和下发短信中的唯一密码为准，如无法登陆，请拨打客服电话：400-620-1800；";
